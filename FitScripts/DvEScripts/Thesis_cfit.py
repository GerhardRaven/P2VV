...
mpsi = RealVar('mdau1', Title = 'm(#mu#mu)',     Unit = 'MeV/c^{2}', Observable = True, MinMax = (3030, 3150), nBins =  32 )
mphi = RealVar('mdau2', Title = 'm(KK)',         Unit = 'MeV/c^{2}', Observable = True, MinMax = (1008,1032), nBins =  16 )
