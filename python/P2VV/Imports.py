...
parValues = {  'A0Mag2'            : (  5.2111e-01,  3.44e-03, -1. )
             , 'ASOddPhase_bin0'   : (  8.4729e-01,  1.94e-01, -1. )
             , 'ASOddPhase_bin1'   : (  2.1579e+00,  2.96e-01, -1. )
             , 'ASOddPhase_bin2'   : (  4.6088e-01,  2.09e-01, -1. )
             , 'ASOddPhase_bin3'   : ( -3.6549e-01,  1.86e-01, -1. )
             , 'ASOddPhase_bin4'   : ( -6.4356e-01,  1.73e-01, -1. )
             , 'ASOddPhase_bin5'   : ( -9.2235e-01,  1.44e-01, -1. )
             , 'AparPhase'         : (  3.2678e+00,  1.24e-01, -1. )
             , 'AperpMag2'         : (  2.5328e-01,  4.96e-03, -1. )
             , 'AperpPhase'        : (  3.1936e+00,  1.16e-01, -1. )
             , 'Gamma'             : (  6.6091e-01,  6.00e-03, -1. )
             , '__dGamma__'        : (  8.7937e-02,  9.14e-03, -1. )
             , '__phiCP__'         : (  7.0841e-02,  5.17e-02, -1. )
             , 'betaTimeEff_p2011' : ( -8.2725e-03,  4.00e-03, -1. )
             , 'betaTimeEff_p2012' : ( -1.3613e-02,  6.55e-03, -1. )
             , 'dM'                : (  1.77625e+01, 2.21e-02, -1. )
             , 'f_S_bin0'          : (  4.4229e-01,  5.64e-02, -1. )
             , 'f_S_bin1'          : (  5.4800e-02,  1.81e-02, -1. )
             , 'f_S_bin2'          : (  9.6364e-03,  6.60e-03, -1. )
             , 'f_S_bin3'          : (  8.8058e-03,  5.77e-03, -1. )
             , 'f_S_bin4'          : (  4.6677e-02,  1.59e-02, -1. )
             , 'f_S_bin5'          : (  1.9076e-01,  2.57e-02, -1. )
             , 'lambdaCP'          : (  9.6125e-01,  1.84e-02, -1. )
             , 'wTagDelP0OS'       : (  1.3722e-02,  1.20e-03, -1. )
             , 'wTagDelP0SS'       : ( -1.5992e-02,  2.00e-03, -1. )
             , 'wTagDelP1OS'       : (  6.9711e-02,  1.20e-02, -1. )
             , 'wTagDelP1SS'       : (  1.5153e-02,  1.90e-02, -1. )
             , 'wTagP0OS'          : (  3.9146e-01,  9.14e-03, -1. )
             , 'wTagP0SS'          : (  4.3884e-01,  6.71e-03, -1. )
             , 'wTagP1OS'          : (  1.0275e+00,  5.70e-02, -1. )
             , 'wTagP1SS'          : (  9.2024e-01,  1.03e-01, -1. )
            }
