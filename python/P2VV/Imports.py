...
parValues4KKBins = {  'phiCP'           : (  5.8786e-02, 8.99e-02, -1.       )
                    , 'lambdaCP'        : (  9.4697e-01, 3.09e-02, -1.       )
                    , 'Gamma'           : (  6.7182e-01, 4.81e-03, -1.       )
                    , 'dGamma'          : (  1.0129e-01, 1.63e-02, -1.       )
                    , 'dM'              : (  1.7651e+01, 7.94e-02, -1.       )
                    , 'A0Mag2'          : (  5.2136e-01, 6.12e-03, -1.       )
                    , 'AperpMag2'       : (  2.4807e-01, 8.78e-03, -1.       )
                    , 'f_S_bin0'        : (  2.2725e-01, 7.71e-02, -1.       )
                    , 'f_S_bin1'        : (  2.5698e-02, 1.33e-02, -1.       )
                    , 'f_S_bin2'        : (  2.6134e-02, 1.16e-02, -1.       )
                    , 'f_S_bin3'        : (  1.6819e-01, 4.23e-02, -1.       )
                    , 'AparPhase'       : (  3.3126e+00, 1.61e-01, -1.       )
                    , 'AperpPhase'      : (  3.0547e+00, 2.22e-01, -1.       )
                    , 'ASOddPhase_bin0' : (  1.3262e+00, 6.92e-01, -1.       )
                    , 'ASOddPhase_bin1' : (  5.9867e-01, 2.42e-01, -1.       )
                    , 'ASOddPhase_bin2' : ( -5.3132e-01, 1.95e-01, -1.       )
                    , 'ASOddPhase_bin3' : ( -6.4594e-01, 1.97e-01, -1.       )
                    , 'timeResSigmaSF'  : (  1.4490e+00, 5.93e-02, -1.       )
                    , 'wTagP0OS'        : (  3.9087e-01, 7.68e-03, -1.       )
                    , 'wTagP0SS'        : (  3.6034e-01, 1.59e-02, -1.       )
                    , 'wTagP1OS'        : (  1.0004e+00, 2.29e-02, -1.       )
                    , 'wTagP1SS'        : (  1.0223e+00, 1.57e-01, -1.       )
                    , 'wTagDelP0OS'     : (  1.0997e-02, 3.40e-03, -1.       )
                    , 'wTagDelP0SS'     : ( -1.9049e-02, 5.00e-03, -1.       )
                   }
