...
parValues = {  'A0Mag2'            : (  5.23467e-01, 3.44e-03, -1 )
             , 'ASOddPhase_bin0'   : (  8.43321e-01, 1.99e-01, -1 )
             , 'ASOddPhase_bin1'   : (  2.14602e+00, 2.82e-01, -1 )
             , 'ASOddPhase_bin2'   : (  4.83408e-01, 2.24e-01, -1 )
             , 'ASOddPhase_bin3'   : ( -3.64298e-01, 1.82e-01, -1 )
             , 'ASOddPhase_bin4'   : ( -5.92545e-01, 1.56e-01, -1 )
             , 'ASOddPhase_bin5'   : ( -9.07977e-01, 1.40e-01, -1 )
             , 'AparPhase'         : (  3.25631e+00, 1.25e-01, -1 )
             , 'AperpMag2'         : (  2.51529e-01, 4.89e-03, -1 )
             , 'AperpPhase'        : (  3.09986e+00, 1.44e-01, -1 )
             , 'Gamma'             : (  6.59182e-01, 3.11e-03, -1 )
             , '__dGamma__'        : (  8.75520e-02, 9.10e-03, -1 )
             , '__phiCP__'         : (  7.31251e-02, 4.99e-02, -1 )
             , 'betaTimeEff_p2011' : ( -8.62162e-03, 2.04e-03, -1 )
             , 'betaTimeEff_p2012' : ( -1.26577e-02, 1.80e-03, -1 )
             , 'dM'                : (  1.77228e+01, 5.63e-02, -1 )
             , 'f_S_bin0'          : (  4.26748e-01, 5.40e-02, -1 )
             , 'f_S_bin1'          : (  5.87081e-02, 1.76e-02, -1 )
             , 'f_S_bin2'          : (  9.55957e-03, 6.59e-03, -1 )
             , 'f_S_bin3'          : (  9.41265e-03, 5.85e-03, -1 )
             , 'f_S_bin4'          : (  4.82033e-02, 1.55e-02, -1 )
             , 'f_S_bin5'          : (  1.92283e-01, 2.55e-02, -1 )
             , 'lambdaCP'          : (  9.62566e-01, 1.88e-02, -1 )
             , 'wTagP0OS'          : (  3.81507e-01, 4.25e-03, -1 )
             , 'wTagP0SS'          : (  4.45857e-01, 4.64e-03, -1 )
             , 'wTagP1OS'          : (  1.01199e+00, 3.44e-02, -1 )
             , 'wTagP1SS'          : (  9.58204e-01, 8.26e-02, -1 )
            }

parValuesCPVDecay = {  'ASOddPhase_bin0'        : (  0.864849,   2.03e-01, -1 )
                     , 'ASOddPhase_bin1'        : (  2.11863,    3.13e-01, -1 )
                     , 'ASOddPhase_bin2'        : (  0.531425,   2.55e-01, -1 )
                     , 'ASOddPhase_bin3'        : ( -0.356457,   1.84e-01, -1 )
                     , 'ASOddPhase_bin4'        : ( -0.588043,   1.59e-01, -1 )
                     , 'ASOddPhase_bin5'        : ( -0.905389,   1.47e-01, -1 )
                     , 'AparPhase'              : (  3.24606,    1.33e-01, -1 )
                     , 'AperpPhase'             : (  3.03706,    1.65e-01, -1 )
                     , 'CCPAv'                  : ( -0.00635953, 3.87e-02, -1 )
                     , 'CCPAv_AS'               : (  0.0601428,  3.23e-02, -1 )
                     , 'CCPRel_Apar'            : ( -0.0270257,  1.22e-01, -1 )
                     , 'CCPRel_Aperp'           : (  0.0433727,  1.62e-01, -1 )
                     , 'Gamma'                  : (  0.659078,   3.11e-03, -1 )
                     , '__dGamma__'             : (  0.0875578,  9.11e-03, -1 )
                     , '__phiCPAv__'            : (  0.133614,   5.10e-02, -1 )
                     , '__phiCPRel_AS__'        : ( -0.22061,    6.22e-02, -1 )
                     , '__phiCPRel_Apar__'      : ( -0.127357,   4.27e-02, -1 )
                     , '__phiCPRel_AperpApar__' : (  0.0937813,  2.86e-02, -1 )
                     , 'avA02'                  : (  0.523425,   3.44e-03, -1 )
                     , 'avAperp2'               : (  0.251546,   4.92e-03, -1 )
                     , 'avf_S_bin0'             : (  0.424671,   5.42e-02, -1 )
                     , 'avf_S_bin1'             : (  0.0569122,  1.77e-02, -1 )
                     , 'avf_S_bin2'             : (  0.00852442, 6.56e-03, -1 )
                     , 'avf_S_bin3'             : (  0.00924993, 5.63e-03, -1 )
                     , 'avf_S_bin4'             : (  0.0477403,  1.54e-02, -1 )
                     , 'avf_S_bin5'             : (  0.191136,   2.56e-02, -1 )
                     , 'betaTimeEff_p2011'      : ( -0.00861765, 2.04e-03, -1 )
                     , 'betaTimeEff_p2012'      : ( -0.0126785,  1.80e-03, -1 )
                     , 'dM'                     : (  17.6957,    6.15e-02, -1 )
                     , 'wTagP0OS'               : (  0.381176,   4.25e-03, -1 )
                     , 'wTagP0SS'               : (  0.446157,   4.67e-03, -1 )
                     , 'wTagP1OS'               : (  1.01141,    3.45e-02, -1 )
                     , 'wTagP1SS'               : (  0.966134,   8.30e-02, -1 )
                    }
