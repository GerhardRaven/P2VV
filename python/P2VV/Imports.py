...
parValues = {  'A0Mag2'            : (  5.2108e-01, 3.44e-03, -1 )
             , 'ASOddPhase_bin0'   : (  8.4498e-01, 1.99e-01, -1 )
             , 'ASOddPhase_bin1'   : (  2.1655e+00, 2.64e-01, -1 )
             , 'ASOddPhase_bin2'   : (  4.7345e-01, 2.12e-01, -1 )
             , 'ASOddPhase_bin3'   : ( -3.6813e-01, 1.88e-01, -1 )
             , 'ASOddPhase_bin4'   : ( -6.1023e-01, 1.58e-01, -1 )
             , 'ASOddPhase_bin5'   : ( -8.9872e-01, 1.40e-01, -1 )
             , 'AparPhase'         : (  3.2715e+00, 1.17e-01, -1 )
             , 'AperpMag2'         : (  2.5310e-01, 4.96e-03, -1 )
             , 'AperpPhase'        : (  3.1835e+00, 1.12e-01, -1 )
             , 'Gamma'             : (  6.6120e-01, 6.00e-03, -1 )
             , '__dGamma__'        : (  8.7458e-02, 9.16e-03, -1 )
             , '__phiCP__'         : (  7.9061e-02, 4.99e-02, -1 )
             , 'betaTimeEff_p2011' : ( -8.3000e-03, 4.00e-03, -1 )
             , 'betaTimeEff_p2012' : ( -1.3495e-02, 6.54e-03, -1 )
             , 'dM'                : (  1.77622e+01, 2.20e-02, -1 )
             , 'f_S_bin0'          : (  4.4276e-01, 5.48e-02, -1 )
             , 'f_S_bin1'          : (  6.0118e-02, 1.75e-02, -1 )
             , 'f_S_bin2'          : (  1.0351e-02, 6.82e-03, -1 )
             , 'f_S_bin3'          : (  8.9697e-03, 5.78e-03, -1 )
             , 'f_S_bin4'          : (  4.9227e-02, 1.56e-02, -1 )
             , 'f_S_bin5'          : (  1.8993e-01, 2.56e-02, -1 )
             , 'lambdaCP'          : (  9.6236e-01, 1.82e-02, -1 )
             , 'wTagP0OS'          : (  3.8770e-01, 4.25e-03, -1 )
             , 'wTagP0SS'          : (  4.5073e-01, 4.64e-03, -1 )
             , 'wTagP1OS'          : (  1.0112e+00, 3.44e-02, -1 )
             , 'wTagP1SS'          : (  9.5715e-01, 8.23e-02, -1 )
            }
