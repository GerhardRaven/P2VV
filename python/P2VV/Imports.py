...
parValues = {  'A0Mag2'            : (  5.2369e-01, 3.44e-03, -1 )
             , 'ASOddPhase_bin0'   : (  8.4326e-01, 1.99e-01, -1 )
             , 'ASOddPhase_bin1'   : (  2.1475e+00, 2.81e-01, -1 )
             , 'ASOddPhase_bin2'   : (  4.8303e-01, 2.23e-01, -1 )
             , 'ASOddPhase_bin3'   : ( -3.6419e-01, 1.82e-01, -1 )
             , 'ASOddPhase_bin4'   : ( -5.9230e-01, 1.56e-01, -1 )
             , 'ASOddPhase_bin5'   : ( -9.0811e-01, 1.40e-01, -1 )
             , 'AparPhase'         : (  3.2567e+00, 1.24e-01, -1 )
             , 'AperpMag2'         : (  2.5120e-01, 4.90e-03, -1 )
             , 'AperpPhase'        : (  3.0984e+00, 1.44e-01, -1 )
             , 'Gamma'             : (  6.5915e-01, 3.11e-03, -1 )
             , '__dGamma__'        : (  8.8520e-02, 9.14e-03, -1 )
             , '__phiCP__'         : (  7.2954e-02, 4.97e-02, -1 )
             , 'betaTimeEff_p2011' : ( -8.6393e-03, 2.04e-03, -1 )
             , 'betaTimeEff_p2012' : ( -1.2669e-02, 1.80e-03, -1 )
             , 'dM'                : (  1.7723e+01, 5.67e-02, -1 )
             , 'f_S_bin0'          : (  4.2626e-01, 5.40e-02, -1 )
             , 'f_S_bin1'          : (  5.8754e-02, 1.76e-02, -1 )
             , 'f_S_bin2'          : (  9.5570e-03, 6.58e-03, -1 )
             , 'f_S_bin3'          : (  9.4094e-03, 5.84e-03, -1 )
             , 'f_S_bin4'          : (  4.8163e-02, 1.55e-02, -1 )
             , 'f_S_bin5'          : (  1.9205e-01, 2.55e-02, -1 )
             , 'lambdaCP'          : (  9.6270e-01, 1.88e-02, -1 )
             , 'wTagP0OS'          : (  3.8153e-01, 4.25e-03, -1 )
             , 'wTagP0SS'          : (  4.4586e-01, 4.64e-03, -1 )
             , 'wTagP1OS'          : (  1.0119e+00, 3.44e-02, -1 )
             , 'wTagP1SS'          : (  9.5814e-01, 8.26e-02, -1 )
            }

parValuesCPVDecay = {  'ASOddPhase_bin0'        : (  8.6522e-01, 2.03e-01, -1 )
                     , 'ASOddPhase_bin1'        : (  2.1244e+00, 3.09e-01, -1 )
                     , 'ASOddPhase_bin2'        : (  5.2759e-01, 2.51e-01, -1 )
                     , 'ASOddPhase_bin3'        : ( -3.5408e-01, 1.83e-01, -1 )
                     , 'ASOddPhase_bin4'        : ( -5.8497e-01, 1.58e-01, -1 )
                     , 'ASOddPhase_bin5'        : ( -9.0484e-01, 1.47e-01, -1 )
                     , 'AparPhase'              : (  3.2454e+00, 1.33e-01, -1 )
                     , 'AperpPhase'             : (  3.0349e+00, 1.65e-01, -1 )
                     , 'CCPAv'                  : ( -6.4249e-03, 3.87e-02, -1 )
                     , 'CCPAv_AS'               : (  5.9629e-02, 3.21e-02, -1 )
                     , 'CCPRel_Apar'            : ( -2.4850e-02, 1.22e-01, -1 )
                     , 'CCPRel_Aperp'           : (  4.3486e-02, 1.62e-01, -1 )
                     , 'Gamma'                  : (  6.5910e-01, 3.11e-03, -1 )
                     , '__dGamma__'             : (  8.8366e-02, 9.15e-03, -1 )
                     , '__phiCPAv__'            : (  1.3348e-01, 5.10e-02, -1 )
                     , '__phiCPRel_AS__'        : ( -2.2047e-01, 6.21e-02, -1 )
                     , '__phiCPRel_Apar__'      : ( -1.2757e-01, 4.26e-02, -1 )
                     , '__phiCPRel_AperpApar__' : (  9.3422e-02, 2.87e-02, -1 )
                     , 'avA02'                  : (  5.2365e-01, 3.44e-03, -1 )
                     , 'avAperp2'               : (  2.5126e-01, 4.93e-03, -1 )
                     , 'avf_S_bin0'             : (  4.2439e-01, 5.42e-02, -1 )
                     , 'avf_S_bin1'             : (  5.7216e-02, 1.77e-02, -1 )
                     , 'avf_S_bin2'             : (  8.6280e-03, 6.57e-03, -1 )
                     , 'avf_S_bin3'             : (  9.2936e-03, 5.63e-03, -1 )
                     , 'avf_S_bin4'             : (  4.7929e-02, 1.54e-02, -1 )
                     , 'avf_S_bin5'             : (  1.9107e-01, 2.55e-02, -1 )
                     , 'betaTimeEff_p2011'      : ( -8.6392e-03, 2.04e-03, -1 )
                     , 'betaTimeEff_p2012'      : ( -1.2669e-02, 1.80e-03, -1 )
                     , 'dM'                     : (  1.7696e+01, 6.21e-02, -1 )
                     , 'wTagP0OS'               : (  3.8121e-01, 4.25e-03, -1 )
                     , 'wTagP0SS'               : (  4.4614e-01, 4.66e-03, -1 )
                     , 'wTagP1OS'               : (  1.0113e+00, 3.44e-02, -1 )
                     , 'wTagP1SS'               : (  9.6585e-01, 8.30e-02, -1 )
                    }
