...
sig_t = Pdf( 'time', { ( t, ) : { 'Type'            : 'Decay',
                                    'Parameters'      : ( sig_tau, ),
                                    'Options'         : ( 'SingleSided', ),
                                    'ResolutionModel' : sig_res }
                         }
             )
...
background[ m ] = Pdf( 'background', { ( m, ) : { 'Type' : 'Exponential',
...
background[ t ] = Pdf( 'background', { ( t, ) : { 'Type'            : 'Decay',
                                                  'Parameters'      : ( background_tau, ),
                                                  'Options'         : ( 'SingleSided', ),
