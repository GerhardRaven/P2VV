...
class LP2011_TimeResolution ( TimeResolution ) :
    def __init__( self, **kwargs ) :
        ...
        self._timeResSF = self._parseArg('%stimeResSF' % namePF, kwargs, Value = 1.0, Error = 0.04, MinMax = ( 0.1, 10. ) )
...
class Moriond2012_TimeResolution ( TimeResolution ) :
    def __init__( self, **kwargs ) :
        ...
        self._parseArg( 'timeResSF', kwargs, Value = 1.45, Error = 0.06, MinMax = ( 0.1, 10. ) )
