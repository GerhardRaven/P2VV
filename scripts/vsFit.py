...
myPath = '/project/bfys/vsyropou/data/Bs2JsiPhi/'
...
pdfConfig['timeEffHistFiles'].getSettings( [ ( 'runPeriod', 'p2011' ) ] )['file']\
        = dataPath + 'Reco14/Bs_HltPropertimeAcceptance_Data_2011_40bins_TOS.root'
pdfConfig['timeEffHistFiles'].getSettings( [ ( 'runPeriod', 'p2012' ) ] )['file']\
        = dataPath + 'Reco14/Bs_HltPropertimeAcceptance_Data_2012_40bins_TOS.root'
 # decay angles
pdfConfig['anglesEffType']   = 'weights'
pdfConfig['angEffMomsFiles'] = options.AngAccFile if options.AngAccFile \
    else myPath + 'correctedEffMoms/Sim08_20112012_hel_UB_UT_trueTime_BkgCat050_KK30_Phys_moms_norm'
 # update default ang acc with the corrected one. 

#####################################################################################################################
## read data and buil pdf ##
############################
