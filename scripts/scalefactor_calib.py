...
class ErrorSFC(object):
    ...
    def __call__(self, w, st, pars):
        pars = pars[0]
        for i in range(4):
            d = self.__d[i](st, self.__dms.value(), pars[0].value(),
