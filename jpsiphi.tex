...
\begin{eqnarray}
    {\cal A} &=& %\frac{ (A_{CP}/{\cal D}-\Delta)(1+\delta\nu)- (\delta+\nu) }{1+\delta\nu - ( A_{CP}/{\cal D}-\Delta ) (\delta+\nu) }
% \\     &=& 
     \frac{ {A_{CP}(1+\delta\nu)}-{\cal D}\left[ \Delta(1+\delta\nu)  + \delta+\nu \right] }{{\cal D}\left[1+\delta\nu+\Delta(\delta+\nu)\right] -  A_{CP}(\delta+\nu)   }
%    {\cal A} = \frac{A_{CP}-{\cal D}\left(\nu+\delta+\Delta-\delta^2\nu+\delta\nu^2\right)}{{\cal D}(1+\delta^2+\nu^2+2\delta\nu+{\cal A}(\nu+\delta))}
\\ &=& \frac{A_{CP}}{\cal D}\left[ \frac{1-{\cal D}(\Delta+\frac{\delta+\nu }{1+\delta\nu})}{1-(\frac{A_{CP}}{\cal D}-\Delta)\frac{\delta+\nu}{1+\delta\nu} } \right]
\end{eqnarray}
