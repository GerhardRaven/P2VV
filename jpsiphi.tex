...
\hline
n   
& \begin{array}{l}  K_n(z)   = \\  \left. \left( \frac{d}{d\lambda} \right)^n\right|_{\lambda=0} \frac{e^{\frac{1}{2}\lambda^2}}{z-\lambda}  \end{array}
& \begin{array}{l}  M_n(x;z) = \\  \left. \left( \frac{d}{d\lambda} \right)^n\right|_{\lambda=0} \left[ \mathrm{erf}\left(\frac{x-\lambda}{\sqrt{2}}\right)-  e^{-\frac{1}{2}\left(x-\lambda\right)^2}w\left(\frac{i}{\sqrt{2}}\left(z-x\right)\right)  \right] \end{array}
\\ \hline 
...
\end{eqnarray}
We give here the expressions for $n=0,1,2,3$ (check!)
\begin{eqnarray*}
    I_0(x;z) &=& \frac{1}{z}\left[  \mathrm{erf}\left(\frac{x}{\sqrt{2}}\right)-e^{-\frac{1}{2}x^2}w\left( \frac{i}{\sqrt{2}} \left(z-x\right)\right)   \right]
\\  I_1(x;z) &=& \frac{1}{z}\left[I_0(x,z)-e^{-\frac{1}{2}x^2}\left( \sqrt{\frac{2}{\pi}} + x w\left( \frac{i}{\sqrt{2}}(z-x)\right) \right)  \right]
\\  I_2(x;z) &=& 
\\  I_3(x;z) &=& 
\end{eqnarray*}
