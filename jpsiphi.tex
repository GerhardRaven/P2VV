...
\begin{eqnarray*}
       I(x_\mathrm{min},x_\mathrm{max};z,\lambda) &=& \int_{x_\mathrm{min}}^{x_\mathrm{max}} dx\; e^{2\lambda x} e^{-x^2} w\left( i(z-x)\right) 
        ...
        \\            &=& \frac{e^{\lambda^2}}{z-\lambda} \left[ \mathrm{erf}\left( x \right) - e^{-x^2}w\left(i\left(z-\lambda-x \right) \right) \right]_{x_\mathrm{min}-\lambda}^{x_\mathrm{max}-\lambda}
...
\hline
n   
& \begin{array}{l}  K_n(z)   = \\  \left. \frac{d^n}{d\lambda^n}\right|_{\lambda=0} \frac{e^{\lambda^2}}{z-\lambda}  \end{array}
...
\\ 1   & \frac{1}{z^2}                             & 2 e^{-x^2} \left[ - \sqrt{\frac{1}{\pi}}   -       x w\left(i(z-x)  \right) \right]
\\ 2   & \frac{2}{z}\left(1 + \frac{1}{z^2}\right) & 2 e^{-x^2} \left[ - 2x  \sqrt{\frac{1}{\pi}}  - (2x^2-1) w\left(i(z-x)\right) \right]
\\ 3   & \frac{6}{z^2}\left(1+\frac{1}{z^2}\right) & 4 e^{-x^2} \left[ - (2x^2-1)\sqrt{\frac{1}{\pi}} -x(2x^2-3)w\left(i(z-x)\right)   \right]
\\ \hline
\end{array}
\end{equation}
