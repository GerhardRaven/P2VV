...
\\             &=&\frac{1}{z}\left[ \mathrm{erf}\left(x\right) -e^{-x^2} w\left( i\left(z-x\right) \right) \right]_{x_\mathrm{min}}^{x_\mathrm{max}}
\end{eqnarray*}
...
\begin{eqnarray*}
       I(x_\mathrm{min},x_\mathrm{max};z,\lambda) &=& \int_{x_\mathrm{min}}^{x_\mathrm{max}} dx\; e^{2\lambda x} e^{-x^2} w\left( i(z-x)\right) 
        \\            &=& e^{\frac{1}{4}\lambda^2}\int_{x_\mathrm{min}-\lambda/2}^{x_\mathrm{max}-\lambda/2} dx \;  e^{-x^2} w\left(i\left(z-\lambda/2-x\right) \right)
        \\            &=& \frac{e^{\frac{1}{4}\lambda^2}}{z-\lambda/2} \left[ \mathrm{erf}\left( x \right) - e^{-x^2}w\left(i\left(z-\lambda/2-x \right) \right) \right]_{x_\mathrm{min}-\lambda/2}^{x_\mathrm{max}-\lambda/2}
        \\            &\equiv& K(z,\lambda) \left[  J(x_\mathrm{max};\lambda,z) - J(x_\mathrm{min};\lambda,z)  \right]
\end{eqnarray*}
where $K(\lambda,z)=\frac{e^{\frac{1}{4}\lambda^2}}{z-\lambda/2}$ and $J(x;\lambda,z)=\mathrm{erf}\left(x-\frac{\lambda}{2}\right)-e^{-\left(x-\frac{\lambda}{2}\right)^2}w\left(i\left(z-x\right) \right)$. 
...
\hline
n   
& \begin{array}{l}  K_n(z)   = \\  \left. \frac{d^n}{d\lambda^n}\right|_{\lambda=0} \frac{e^{\frac{1}{4}\lambda^2}}{z-\lambda/2}  \end{array}
...
\\ \hline 
   0   & \frac{1}{z}                                &  \mathrm{erf}\left(x\right)-e^{-x^2}w\left( i \left(z-x\right)\right) 
\\ 1   & \frac{1}{2z^2}                             & e^{-x^2} \left[ - \sqrt{\frac{1}{\pi}}   -       x w\left(i(z-x)  \right) \right]
\\ 2   & \frac{1}{2z}\left(1 + \frac{1}{z^2}\right) & e^{-x^2} \left[ - \sqrt{\frac{1}{\pi}} x - (x^2-\frac{1}{2}) w\left(i(z-x)\right) \right]
\\ 3   & \frac{3}{4z^2}\left(1+\frac{1}{z^2}\right) & e^{-x^2} \left[ - \sqrt{\frac{1}{\pi}} (x^2-\frac{1}{2})-x(x^2-\frac{3}{2})w\left(i(z-x)\right)   \right]
\\ \hline
\end{array}
\end{equation}
...
Note that (unfortunately) the knotvector depends on $x$, not $t$, and thus any change in $\sigma$ implies a recomputation 
of all quantities which depend on the definition of the knotvector.
...
\begin{equation}
     ...
     = \left( \begin{array}{ccc}
          1 &  0 & -1
     \\   0 & -\sqrt{\frac{1}{\pi}}& -x 
     \\   0 & -\sqrt{\frac{1}{\pi}}x& -(x^2-\frac{1}{2}) 
     \\   0 & -\sqrt{\frac{1}{\pi}}(x^2-\frac{1}{2})& -x(x^2-\frac{3}{2}) 
       \end{array}\right) 
       \left(\begin{array}{c} 
