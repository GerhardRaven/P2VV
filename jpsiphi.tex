...
\Re({\cal A}_0^*(t){\cal A}_\parallel(t))     &\frac{  \Re(a_0^*a_\parallel)e^{-t/\tau}}{1+C}     & 1    &   C     &  -D & -S   \\
 ...
 \hline
|{\cal\overline{ A}}_0(t)|^2                &\frac{  | a_0 |^2 e^{-t/\tau}}{1-C}                & 1    &  -C     &  -D & +S   \\
|{\cal\overline{ A}}_\parallel(t)|^2        &\frac{  | a_\parallel |^2 e^{-t/\tau}}{1-C}        & 1    &  -C     &  -D & +S   \\
|{\cal\overline{ A}}_\perp(t)|^2            &\frac{  | a_\perp |^2 e^{-t/\tau}}{1-C}            & 1    &  -C     &  +D & -S   \\
\Im({\cal \overline{A}}_\parallel(t){\cal\overline{ A}}_\perp(0)) &\frac{  \Re(a_\parallel^* a_\perp)e^{-t/\tau}}{1-C} &  0    &   0     &  -S & -D               \\                         
                                            &\frac{  \Im(a_\parallel^* a_\perp)e^{-t/\tau}}{1-C}                       & -C    &   1     &   0 & 0                \\
\Im({\cal\overline{ A}}_0(t){\cal\overline{ A}}_\perp(t))         &\frac{  \Re(a_0^* a_\perp)e^{-t/\tau}}{1-C}         &  0    &   0     &  -S & -D               \\
                                            &\frac{  \Im(a_0^* a_\perp)e^{-t/\tau}}{1-C}                               & -C    &   1     &   0 &  0              \\
\Re({\cal\overline{ A}}_0(t){\cal\overline{ A}}_\parallel(t))     &\frac{  \Re(a_0^*a_\parallel)e^{-t/\tau}}{1-C}      &  1    &   -C    &  -D & +S               \\
                                            &\frac{  \Im(a_0^*a_\parallel)e^{-t/\tau}}{1-C}                            &  0    &   0     &   0 &  0               \\
 \hline
\end{array}
\end{equation}
...
\begin{eqnarray}
\frac{1}{N_{\mathrm{gen}}} \sum_{\mathrm{accepted events}} \frac{2i+1}{2}\frac{ P_i(\cos\psi)Y_{jk}(\cos\theta,\phi) }{ g(\vec{x} } \right] &=&\\
    \int g(\cos\psi,\cos\theta,\phi)d\cos\psi d\cos\theta d\phi c^l_{mn} P_l(\cos\psi)Y_{mn}(\cos\theta,\phi) \left[  \frac{2i+1}{2}\frac{ P_i(\cos\psi)Y_{jk}(\cos\theta,\phi) }{ g(\vec{x} } \right] &=&\\
    &=& c^i_{jk}
\end{eqnarray}
