...
\\                          &=& \frac{1}{\sqrt{2\pi}} \int_0^{+\infty}\;dy \;\; e^{-z y }\;\; e^{-\frac{1}{2}\left( x-y \right)^2}
\end{eqnarray*}
...
\\                          &=&  e^{-\frac{1}{2}x^2+\frac{1}{2}(z-x)^2}  \; \mathrm{erfc}\left(\frac{z-x}{\sqrt{2}} \right)
\end{eqnarray*}
Finally, we use the Faddeeyv function $w$,  defined as 
\begin{equation}
