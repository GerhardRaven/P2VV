...
\begin{equation}
\frac{9}{16 \pi}\frac{\sqrt{4 \pi}}{9} = \frac{1}{8 \sqrt{\pi}}
\end{equation}
...
In particular, an online integrator can explicitly calculate the integrals $\int_{-1}^{1}P_2^1P_i^0\mathrm{d}x$ where  $i = 1,3,5,...$ to find the coefficients in the $\Re({\cal A}_0^*{\cal A}_\parallel)$ and $\Im({\cal A}_\perp^* {\cal A}_0 )$ terms. The same goes for the integrals $\int_{-1}^{1}P_1^1P_i^0\mathrm{d}x$ where $i=0,2,4,...$ for the terms $\Re({\cal A}_{s}^*(t){\cal A}_\parallel(t))$ and $\Im({\cal A}_{s}^*(t){\cal A}_\perp(t))$.
