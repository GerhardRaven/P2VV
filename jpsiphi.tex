...
\begin{eqnarray}
   P_{B_\mathrm{tag}} &=& (1-w) P_{B} + \overline{w} P_{\overline{ B} } \\
     ...
     &=& \frac{  \left[ (1-\Delta w) - {\cal D}C \right]{\cal E}
                               +\left[ {\cal D} - ( 1-\Delta w) C \right] {\cal O}
                     }{1-C^2} \\
   P_{\overline{B}_\mathrm{tag}} &=& w P_{B} + (1-\overline{w}) P_{\overline{ B} } \\
     &=& \frac{  \left[ (1+\Delta w) + {\cal D}C \right]{\cal E}
                               -\left[ {\cal D} + ( 1+\Delta w) C \right] {\cal O}
                        }{1-C^2}\ \\
\end{eqnarray} 
...
\begin{eqnarray}
 \Delta w &\equiv& w-\overline{w} \\
 <w> &\equiv & \frac{w+\overline{w}}{2}\\
 {\cal D} &=&1-2<w> \\
\end{eqnarray}
and used that under $(w\rightarrow 1-w, \overline{w}\rightarrow 1-\overline{w})$ we have $(\Delta w \rightarrow -\Delta w, <w> \rightarrow 1-<w>, {\cal D} \rightarrow -{\cal D})$.
In the limit where $C=0$ and $\Delta w=0$  this reduces to the expected
\begin{eqnarray}
