...
I(x_i,x_{i+1};z,\alpha_i,\beta_i,\gamma_i) &=&
  \int_{x_i}^{x_{i+1}} dx (x-\alpha_i)(x-\beta_i)(x-\gamma_i)  e^{-\frac{1}{2}x^2} w\left( \frac{i}{\sqrt{2}}(z-x) \right) 
\\ &=& I_3(x_i,x_{i+1};z) 
...
\\ &=& 
      ...
      \left(\begin{array}{cccc}
                   -\alpha_i\beta_i\gamma_i                     & \alpha_i\beta_i+\alpha_i\gamma_i+\beta_i\gamma_i & -(\alpha_i+\beta_i+\gamma_i)  &  1
               \\  \alpha_i\beta_i+\alpha_i\gamma_i+\beta_i\gamma_i   &              -2(\alpha_i+\beta_i+\gamma_i) &                      3  &  0
               \\  -(\alpha_i+\beta_i+\gamma_i)                 &                                    3 &                      0  &  0
               \\  1                                      &                                    0 &                      0  &  0
               \end{array}\right) 
       \left(\begin{array}{c} K_0(z) \\ K_1(z) \\ K_2(z) \\ K_3(z) \end{array} \right) 
