...
\\ &\equiv& P_i \times \left( \frac{ 1}{2} + \frac{1}{2} q_T A_{CP}(i) \right)
\label{eq:substrule_e}
\end{eqnarray}
where the $CP$ asymmetry is given by:
\begin{equation}
  A_{CP}(i) =  {\cal D}_i \frac{\left(C_{{\cal O},i}-{\Delta}_i C_{{\cal E},i}\right) {\cal E}+\left( C_{{\cal E},i} - {\Delta}_i C_{{\cal O},i} \right){\cal O}}
...
\begin{eqnarray}
   ...
   P_i(q_T\in(-1,1)) &=& \frac{\epsilon_i}{N}\left[  {\cal E} +q_T {\cal D}_i {\cal O}\right]  \label{eq:substrule_s}\\
