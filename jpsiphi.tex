...
\begin{eqnarray}
 ...
 c^0_{20}  &=& \sqrt{\frac{20}{9}} ( \xi_{\parallel \parallel } - \xi_{\perp\perp} )    \\
 c^0_{2-1} &=& \sqrt{\frac{5}{3}}  \xi_{\parallel \perp}    \\
 c^1_{21}  &=& \sqrt{\frac{5}{6}} \frac{32}{3\pi} \xi_{\perp0}    \\
 c^1_{2-2} &=& \sqrt{\frac{5}{6}} \frac{32}{3\pi} \xi_{0\parallel }
\end{eqnarray}
Note that this choice is not unique, but will (should)  produce the same minimum as a fit which used
the $\xi_{ab}$.
