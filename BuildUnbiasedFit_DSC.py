#Build 2011 Unbiased Fit with DSC parameterization.
...
#ws.factory("Chebychev::bkg_trcospsi(trcospsi,{c0_trcospsi[-1,1],c1_trcospsi[-1,1],c2_trcospsi[-1,1]})")
#ws.factory("Chebychev::bkg_trcostheta(trcostheta,{c0_trcostheta[-1,1],c1_trcostheta[-1,1],c2_trcostheta[-1,1]})")
#ws.factory("Chebychev::bkg_trphi(trphi,{c0_trphi[-1,1],c1_trphi[-1,1],c2_trphi[-1,1]})")
#ws.factory("PROD::ang_bkg(bkg_trcospsi,bkg_trcostheta,bkg_trphi)")
...
wsfile = TFile('UnbiasedWS_DSC.root','RECREATE')
ws.Write()
wsfile.Close()
