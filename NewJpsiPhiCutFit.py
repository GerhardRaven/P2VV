...
wsfile = TFile('NewWSJpsiPhiPdf.root')
...
testCanvas.cd(1)
cpsiframe = cpsi.frame(RooFit.Bins(15))
data.plotOn(cpsiframe,RooFit.CutRange('rightSideband'))
pdf.plotOn(cpsiframe,RooFit.ProjectionRange('rightSideband'))
cpsiframe.Draw()

testCanvas.cd(2)
cpsiframe = cpsi.frame(RooFit.Bins(15))
data.plotOn(cpsiframe,RooFit.CutRange('leftSideband,rightSideband'))
pdf.plotOn(cpsiframe,RooFit.ProjectionRange('leftSideband,rightSideband'))
cpsiframe.Draw()
