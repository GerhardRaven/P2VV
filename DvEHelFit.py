...
### Updated on: Jun 5 11
### Description: This script reads the signal JpsiPhi Pdf in helicity angles from a rootfile
###              Adds bkg PDF's, read data and fits for transversity amplitudes, to be compared later with
###              transversity amplitudes fitted with transversity angles in DvETransFit.py.
########################################
from ROOT import *
...
#ws.factory("Chebychev::bkg_helcosthetaK(helcosthetaK,{c0_helcosthetaK[-0.13],c1_helcosthetaK[0.23],c2_helcosthetaK[-0.057],c3_helcosthetaK[-0.0058],c4_helcosthetaK[-0.0154]})")#,c5_helcosthetaK[-1,1],c6_helcosthetaK[-1,1]})")
#ws.factory("Chebychev::bkg_helcosthetaL(helcosthetaL,{c0_helcosthetaL[0.08],c1_helcosthetaL[-0.22],c2_helcosthetaL[-0.022],c3_helcosthetaL[0.21],c4_helcosthetaL[0.0125]})")#,c5_helcosthetaL[-1,1],c6_helcosthetaL[-1,1]})")
#ws.factory("Chebychev::bkg_helphi(helphi,{c0_helphi[0.10],c1_helphi[0.328],c2_helphi[0.081],c3_helphi[0.316],c4_helphi[0.044]})")#,c5_helphi[-1,1],c6_helphi[-1,1]})")
