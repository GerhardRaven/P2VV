...
if real_data:
    ...
    data = readData(input_file, tree_name, cuts = 'sel == 1 && (hlt1_biased == 1 || hlt1_unbiased == 1) && (hlt2_biased == 1 || hlt2_unbiased == 1) && nPV == 1',
    ...
    input_file = '/home/raaij/data/Bs2JpsiPhi_MC11_biased_unbiased.root'
    data = readData(input_file, tree_name, cuts = 'sel == 1 && (hlt1_biased == 1 || hlt1_unbiased == 1) && (hlt2_biased == 1 || hlt2_unbiased == 1) && nPV == 1',
                    NTuple = True, observables = observables)
    total = data.sumEntries()
