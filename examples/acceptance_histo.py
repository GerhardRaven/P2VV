...
mcpdf = Pdf('mc_pdf', Type = Decay, Observables = [t], ResolutionModel = mc_res, Parameters = [signal_tau], Options = ['SingleSided'])
...
# Signal time pdf
sig_t = Pdf('sig_t', Type = Decay, Observables = [t], Parameters = [signal_tau], ResolutionModel = tres, Options = ['SingleSided'])
...
sig_mpsi = Pdf('sig_mpsi', Type = CrystalBall, Observables = [mpsi], Parameters = [mpsi_mean, mpsi_sigma, mpsi_alpha, mpsi_n])
