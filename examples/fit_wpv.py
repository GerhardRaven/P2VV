...
# B mass pdf
from P2VVParameterizations.MassPDFs import LP2011_Signal_Mass as Signal_BMass
from P2VVParameterizations.MassPDFs import LP2011_Background_Mass as Background_BMass
