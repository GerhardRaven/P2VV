...
taggingParams = Trivial_Dilution( Dilution = Di ) # TODO: add calibration...
...
basisCoefficients = JpsiphiBDecayBasisCoefficients( angles.functions, amplitudes,CP, Di, ['A0','Apar','Aperp','AS'] ) 
...
signal         = Component('signal',         ( sig_m.pdf(),  sig_mpsi.pdf(), sig_st.pdf(), sig_t_angles, sig_tag.pdf() ), Yield = ( nsig, 0.9*nsig, 1.1*nsig) )
